...
namespace SanVicenteHospital.Database
{
    public class DataSeeder
    {
        ...
        )
        {
            ...
            Patient patient1 = new Patient("Joh", "Doe", "Passport", "A12345678", "elcrack1178@gmail.com", 30, "Main St,555-1234", "165462343", new DateOnly(1993, 1, 1));
